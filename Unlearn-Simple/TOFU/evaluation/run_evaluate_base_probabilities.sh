#!/bin/bash
#SBATCH --job-name=base_metrics_eval
...
#SBATCH --output=base_metrics_eval_%j.log

export APPTAINERENV_PYTHONPATH="$SCRATCH/unbranding/evaluation:$SCRATCH/unbranding/extra_python_libs"
...
apptainer exec \
    ...
    $CONTAINER \
    python3.13 -u \
    $SCRATCH/unbranding/Unlearn-Simple/TOFU/evaluation/evaluate_base_probabilites.py
